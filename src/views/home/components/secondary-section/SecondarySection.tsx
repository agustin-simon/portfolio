      ...
      <div className="text-box" ref={contRef}>
        ...
        {activate ? (
          <p>
            ...
            UNICEN University, and my goal is to develop the knowledge acquired
            during my the knowledge acquired during my studies and continue
            learning about the profession.
          </p>
        ) : (
          <p>
            Soy estudiante de Tecnicatura en Desarrollo de Aplicaciones
            Informáticas en la universidad UNICEN, y mi objetivo es desarrollar
            los conocimientos adquiridos durante la carrera y continuar
            aprendiendo sobre la profesion.
          </p>
        )}
      </div>
    </div>
